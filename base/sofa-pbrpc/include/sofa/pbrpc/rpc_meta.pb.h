...
namespace protobuf_sofa_2fpbrpc_2frpc_5fmeta_2eproto {
...
class RpcMeta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sofa.pbrpc.RpcMeta) */ {
 public:
  RpcMeta();
  virtual ~RpcMeta();
 ...
 private:
  ...
  int compress_type_;
  friend struct protobuf_sofa_2fpbrpc_2frpc_5fmeta_2eproto::TableStruct;
};
// ===================================================================
...
// optional int64 server_timeout = 101;
inline bool RpcMeta::has_server_timeout() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void RpcMeta::set_has_server_timeout() {
  _has_bits_[0] |= 0x00000040u;
}
inline void RpcMeta::clear_has_server_timeout() {
  _has_bits_[0] &= ~0x00000040u;
}
...
inline ::google::protobuf::int64 RpcMeta::server_timeout() const {
  // @@protoc_insertion_point(field_get:sofa.pbrpc.RpcMeta.server_timeout)
  return server_timeout_;
}
inline void RpcMeta::set_server_timeout(::google::protobuf::int64 value) {
